...
- Cut production issues 35% via JUnit/Cucumber and JMeter/BlazeMeter testing.
- Building a new fraud-risk product from scratch for a $20B Apple Card portfolio takeover.
- Built an MCP server-client ecosystem — 30% faster feature delivery across 4 teams.

**Product Development Engineer II — Razorpay** *(Aug 2023 – Aug 2024)*
- Automated bank-onboarding, cutting setup time from 1 week to under 1 day for 15+ partner banks.
- Improved reconciliation accuracy to 99.5% across UPI and card rails (Golang).
- Scaled job orchestration to process 2M+ transactions/day.
- Cut mean-time-to-detect production issues by 40% with real-time Grafana dashboards.

**Software Development Engineer — Chargebee Technologies** *(Dec 2021 – Jan 2023)*
- Built a subscription-management-via-SMS microservice from scratch (Node.js, Twilio, AWS).
- Led zero-downtime migration of 100+ merchant sites from v1.0 to v2.0.
